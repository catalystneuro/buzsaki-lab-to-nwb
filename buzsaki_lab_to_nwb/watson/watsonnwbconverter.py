...
class WatsonNWBConverter(NWBConverter):
    ...
    def __init__(self, **input_args):
        ...
        if not os.path.isfile(dat_filepath):
            ...
            input_args.update(
                {"WatsonNoRecording": {"timeseries": np.array(range(n_channels)), "sampling_frequency": 1}}
            )
    ...
    def get_metadata(self):
        ...
        metadata = {
            ...
            self.get_recording_type(): {
                "Ecephys": {
                    ...
                    "ElectricalSeries": {"name": "ElectricalSeries", "description": "raw acquisition traces"},
                }
            },
            ...
            "WatsonLFP": {
                ...
                "lfp": {"name": "lfp", "description": "lfp signal for all shank electrodes"},
                "lfp_decomposition": {},
        ...
        if any(test_list):
            ...
            metadata["WatsonLFP"]["lfp_decomposition"].update(
                {
                    "spindle_reference": {
                        "name": "SpindleDecompositionSeries",
        ...
        if len(celltype_info) < len(se_ids):
            ...
            for missing_id in missing_ids:
                ...
                metadata[self.get_sorting_type()]["UnitProperties"][2]["data"].append(
                    int(unit_map[missing_id]["unit_id"] - 1)
                )
