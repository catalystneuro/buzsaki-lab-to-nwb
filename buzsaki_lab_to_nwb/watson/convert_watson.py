...
convert_sessions = [
    "BWRat17/BWRat17_121712",
    "BWRat17/BWRat17_121912",
    "BWRat18/BWRat18_020513",
    "BWRat19/BWRat19_032513",
    "BWRat19/BWRat19_032413",
    "BWRat20/BWRat20_101013",
    "BWRat20/BWRat20_101513",
    "BWRat21/BWRat21_121113",
    "BWRat21/BWRat21_121613",
    "BWRat21/BWRat21_121813",
    "Bogey/Bogey_012615",
    "Dino/Dino_061814",
    "Dino/Dino_061914",
    "Dino/Dino_062014",  # incorrect # of channels for full lfp reshaping...
    "Dino/Dino_072114" "Dino/Dino_072314",  # , # missing clu files...
    "Dino/Dino_072414",
    "Rizzo/Rizzo_022615",
    "Rizzo/Rizzo_022715",
    "Splinter/Splinter_020515",
    "Splinter/Splinter_020915",
    "Templeton/Templeton_032415",
]

experimenter = "Brendon Watson"
paper_descr = (
    "Data was recorded using silicon probe electrodes in the frontal cortices of male Long "
...
for session in convert_sessions:
    ...
    if session == "Dino/Dino_072114":
        input_args.update(
            {
                "CellExplorerSorting": {
                    "spikes_file_path": os.path.join(folder_path, session_id) + ".spikes.cellinfo.mat"
                }
            }
        )
    else:
        input_args.update({"NeuroscopeSorting": {"folder_path": folder_path, "keep_mua_units": False}})
    ...
    device_descr = "silicon probe electrodes; see {}.xml or {}.sessionInfo.mat for more information".format(
